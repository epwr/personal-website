...
function Home() {
    return (
        <div className="section flex-col">
            ...
            <p>Hi!</p>
            <p>I'm Eric Power. I'm a fullstack software developer and all round nerd who likes talking about everything from 19th century history to the engineering behind gutters.
