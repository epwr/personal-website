    ...
    return (
        <div className="section flex-col">
            ...
            <ul>
                ...
                <li>Designed and built a deck for my parents.</li>
                <li>Read a bunch of books, mostly focusing on 19th century history, but also including some ancient Roman history, economics, political philosophy, and statistics.</li>
